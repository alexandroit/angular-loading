...
let AppComponent = class AppComponent {
    constructor(loadingService) {
        ...
        this.logs = [];
        this.installSnippet = "npm install @stackline/angular-loading@9";
...
module.exports = __webpack_require__(/*! /tmp/stackline-angular-loading-docs-9-pW3hKM/src/main.ts */"./src/main.ts");
