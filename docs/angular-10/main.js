...
module.exports = __webpack_require__(/*! /tmp/stackline-angular-loading-docs-10-Ed07Eo/src/main.ts */"zUnb");
...
let AppComponent = class AppComponent {
    constructor(loadingService) {
        ...
        this.logs = [];
        this.installSnippet = "npm install @stackline/angular-loading@10";
