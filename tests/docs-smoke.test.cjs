...
const htmlFiles = ["docs-src/angular-21/src/index.html"];
const themeFiles = ["docs-src/angular-21/src/app/app.component.css"];
const expectedStrings = ["@stackline/angular-loading"];
