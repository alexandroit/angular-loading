...
const loadingPackageDir = path.join(rootDir, 'node_modules', '@stackline', 'loading-core');
...
if (!fs.existsSync(loadingCjsEntry)) {
  throw new Error('Install root dependencies before building docs so @stackline/loading-core can be copied.');
}
